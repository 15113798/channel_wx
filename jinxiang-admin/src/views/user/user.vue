<template>
	<div class="app-container">
		...
		<el-dialog title="会员信息编辑" :visible.sync="dialogFormVisible">
			<el-form ref="dataForm" :rules="rules" :model="dataForm" status-icon label-position="left" label-width="100px" style="width: 400px; margin-left:50px;">
				...
				<el-form-item label="生日" prop="birthday">
					<el-date-picker v-model="dataForm.birthday" type="date" placeholder="选择日期" value-format="yyyy-MM-dd"></el-date-picker>
				</el-form-item>
				...
				<el-form-item label="关联管理员" prop="adminId">
					<el-select v-model="dataForm.adminId" placeholder="请选择">
						<el-option v-for="(item, index) in adminList" :key="index" :label="item.username" :value="item.id"></el-option>
				  </el-select>
				</el-form-item>
		...
		<!-- 积分对话框 -->
		<el-dialog title="会员积分" :visible.sync="integralFormVisible">
			<el-form ref="integralFrom" :model="integralFrom" status-icon label-position="left" label-width="100px" style="width: 400px; margin-left:50px;">
				...
				<el-form-item label="积分" prop="integral">
					<el-input-number v-model="integralFrom.integral" label="请输入积分数值,正数为增加,负数为减少"></el-input-number>
				</el-form-item>
			</el-form>
			<div slot="footer" class="dialog-footer">
...
<script>
	import {
		fetchList, updateUser, integralSave
	} from '@/api/user'
	...
	export default {
		...
		methods: {
			...
			handleIntegral(row) {console.log(row);
