...
public class SystemConfig {
    // 小程序相关配置
    public final static String LITEMALL_WX_INDEX_NEW = "jinxiang_wx_index_new";
    public final static String LITEMALL_WX_INDEX_HOT = "jinxiang_wx_index_hot";
    public final static String LITEMALL_WX_INDEX_BRAND = "jinxiang_wx_index_brand";
    public final static String LITEMALL_WX_INDEX_TOPIC = "jinxiang_wx_index_topic";
    public final static String LITEMALL_WX_INDEX_CATLOG_LIST = "jinxiang_wx_catlog_list";
    public final static String LITEMALL_WX_INDEX_CATLOG_GOODS = "jinxiang_wx_catlog_goods";
    public final static String LITEMALL_WX_SHARE = "jinxiang_wx_share";
    // 运费相关配置
    public final static String LITEMALL_EXPRESS_FREIGHT_VALUE = "jinxiang_express_freight_value";
    public final static String LITEMALL_EXPRESS_FREIGHT_MIN = "jinxiang_express_freight_min";
    // 订单相关配置
    public final static String LITEMALL_ORDER_UNPAID = "jinxiang_order_unpaid";
    public final static String LITEMALL_ORDER_UNCONFIRM = "jinxiang_order_unconfirm";
    public final static String LITEMALL_ORDER_COMMENT = "jinxiang_order_comment";
    // 商场相关配置
    public final static String LITEMALL_MALL_NAME = "jinxiang_mall_name";
    public final static String LITEMALL_MALL_ADDRESS = "jinxiang_mall_address";
    public final static String LITEMALL_MALL_PHONE = "jinxiang_mall_phone";
    public final static String LITEMALL_MALL_QQ = "jinxiang_mall_qq";
