...
import com.baijuvip.jinxiang.wx.service.GetRegionService;
...
public class WxAddressController extends GetRegionService {
	...
	public Object list(@LoginUser Integer userId) {
		...
		List<JinxiangAddress> addressList = addressService.queryByUid(userId);
	...
	public Object detail(@LoginUser Integer userId, @NotNull Integer id) {
		...
		JinxiangAddress address = addressService.query(userId, id);
		if (address == null) {
	...
	private Object validate(JinxiangAddress address) {
	 ...
	 */
	@PostMapping("save")
	public Object save(@LoginUser Integer userId, @RequestBody JinxiangAddress address) {
		if (userId == null) {
			return ResponseUtil.unlogin();
		}
	 ...
	 */
	@PostMapping("delete")
	public Object delete(@LoginUser Integer userId, @RequestBody JinxiangAddress address) {
		if (userId == null) {
			return ResponseUtil.unlogin();
		}
