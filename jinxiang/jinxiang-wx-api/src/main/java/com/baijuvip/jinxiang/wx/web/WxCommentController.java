...
import com.baijuvip.jinxiang.wx.service.UserInfoService;
...
public class WxCommentController {
    ...
    private Object validate(JinxiangComment comment) {
     ...
     */
    @PostMapping("post")
    public Object post(@LoginUser Integer userId, @RequestBody JinxiangComment comment) {
        if (userId == null) {
    ...
    public Object list(@NotNull Byte type,
        ...
        List<JinxiangComment> commentList = commentService.query(type, valueId, showType, page, limit);

        List<Map<String, Object>> commentVoList = new ArrayList<>(commentList.size());
        for (JinxiangComment comment : commentList) {
