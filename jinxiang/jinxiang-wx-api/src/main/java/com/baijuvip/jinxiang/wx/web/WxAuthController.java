...
import com.baijuvip.jinxiang.db.service.CouponAssignService;
...
import com.baijuvip.jinxiang.wx.dto.UserToken;
import com.baijuvip.jinxiang.wx.dto.WxLoginInfo;
import com.baijuvip.jinxiang.wx.service.CaptchaCodeManager;
import com.baijuvip.jinxiang.wx.service.UserTokenManager;
...
public class WxAuthController {
    ...
    public Object login(@RequestBody String body, HttpServletRequest request) {
        ...
        List<JinxiangUser> userList = userService.queryByUsername(username);
        JinxiangUser user = null;
        if (userList.size() > 1) {
    ...
    public Object register(@RequestBody String body, HttpServletRequest request) {
        ...
        if (userList.size() == 1) {
            JinxiangUser checkUser = userList.get(0);
    ...
    public Object reset(@LoginUser Integer userId, @RequestBody String body, HttpServletRequest request) {
        ...
        List<JinxiangUser> userList = userService.queryByMobile(mobile);
        JinxiangUser user = null;
        if (userList.size() > 1) {
            return ResponseUtil.serious();
        } else if (userList.size() == 0) {
