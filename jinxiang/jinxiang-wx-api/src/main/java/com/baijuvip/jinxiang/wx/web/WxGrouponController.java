...
import com.baijuvip.jinxiang.wx.service.WxGrouponRuleService;
...
public class WxGrouponController {
    ...
    public Object detail(@LoginUser Integer userId, @NotNull Integer grouponId) {
        ...
        JinxiangGroupon groupon = grouponService.queryById(grouponId);
        if (groupon == null) {
        ...
        // 订单信息
        JinxiangOrder order = orderService.findById(groupon.getOrderId());
        if (null == order) {
        ...
        List<JinxiangGroupon> groupons = grouponService.queryJoinRecord(linkGrouponId);

        UserVo joiner;
        for (JinxiangGroupon grouponItem : groupons) {
    ...
    public Object my(@LoginUser Integer userId, @RequestParam(defaultValue = "0") Integer showType) {
        ...
        List<JinxiangGroupon> myGroupons;
        if (showType == 0) {
        ...
        JinxiangOrder order;
        JinxiangGrouponRules rules;
        JinxiangUser creator;
        for (JinxiangGroupon groupon : myGroupons) {
