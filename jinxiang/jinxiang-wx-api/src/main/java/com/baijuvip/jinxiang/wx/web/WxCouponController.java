...
import com.baijuvip.jinxiang.wx.vo.CouponVo;
import com.baijuvip.jinxiang.wx.util.WxResponseCode;
...
public class WxCouponController {
    ...
    public Object list(@RequestParam(defaultValue = "1") Integer page,
        ...
        List<JinxiangCoupon> couponList = couponService.queryList(page, limit, sort, order);
    ...
    public Object mylist(@LoginUser Integer userId,
        ...
        List<JinxiangCouponUser> couponUserList = couponUserService.queryList(userId, null, status, page, limit, sort, order);
        List<CouponVo> couponVoList = change(couponUserList);
        return ResponseUtil.okList(couponVoList, couponUserList);
    }

    private List<CouponVo> change(List<JinxiangCouponUser> couponList) {
        List<CouponVo> couponVoList = new ArrayList<>(couponList.size());
        for(JinxiangCouponUser couponUser : couponList){
    ...
    public Object selectlist(@LoginUser Integer userId, Integer cartId, Integer grouponRulesId) {
        ...
        List<JinxiangCouponUser> availableCouponUserList = new ArrayList<>(couponUserList.size());
    ...
    public Object exchange(@LoginUser Integer userId, @RequestBody String body) {
        ...
        JinxiangCoupon coupon = couponService.findByCode(code);
        if(coupon == null){
