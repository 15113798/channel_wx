...
public class AdminTopicController {
    ...
    public Object list(String title, String subtitle,
        ...
        List<JinxiangTopic> topicList = topicService.querySelective(title, subtitle, page, limit, sort, order);
        return ResponseUtil.okList(topicList);
    }

    private Object validate(JinxiangTopic topic) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody JinxiangTopic topic) {
    ...
    public Object read(@NotNull Integer id) {
        ...
        List<JinxiangGoods> goodsList = null;
    ...
    @PostMapping("/update")
    public Object update(@RequestBody JinxiangTopic topic) {
        Object error = validate(topic);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody JinxiangTopic topic) {
