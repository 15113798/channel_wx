...
public class AdminBrandController {
    ...
    public Object list(String id, String name,
        ...
        List<JinxiangBrand> brandList = brandService.querySelective(id, name, page, limit, sort, order);
        return ResponseUtil.okList(brandList);
    }

    private Object validate(JinxiangBrand brand) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody JinxiangBrand brand) {
    ...
    public Object read(@NotNull Integer id) {
        JinxiangBrand brand = brandService.findById(id);
        return ResponseUtil.ok(brand);
    }
    ...
    @PostMapping("/update")
    public Object update(@RequestBody JinxiangBrand brand) {
        Object error = validate(brand);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody JinxiangBrand brand) {
