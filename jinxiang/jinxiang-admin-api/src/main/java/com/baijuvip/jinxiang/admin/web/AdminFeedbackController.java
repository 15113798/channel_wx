...
import com.baijuvip.jinxiang.db.service.JinxiangFeedbackService;
...
public class AdminFeedbackController {
    ...
    @Autowired
    private JinxiangFeedbackService feedbackService;
    ...
    public Object list(Integer userId, String username,
        ...
        List<JinxiangFeedback> feedbackList = feedbackService.querySelective(userId, username, page, limit, sort, order);
