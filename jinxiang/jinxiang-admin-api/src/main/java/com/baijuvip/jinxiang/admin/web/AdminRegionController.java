...
import com.baijuvip.jinxiang.admin.vo.RegionVo;
...
public class AdminRegionController {
    ...
    public Object clist(@NotNull Integer id) {
        List<JinxiangRegion> regionList = regionService.queryByPid(id);
    ...
    public Object list() {
        ...
        List<JinxiangRegion> provinceList = regionService.queryByPid(0);
        for(JinxiangRegion province : provinceList){
            ...
            List<JinxiangRegion> cityList = regionService.queryByPid(province.getId());
            List<RegionVo> cityVOList = new ArrayList<>();
            for(JinxiangRegion city : cityList){
                ...
                List<JinxiangRegion> areaList = regionService.queryByPid(city.getId());
                List<RegionVo> areaVOList = new ArrayList<>();
                for(JinxiangRegion area : areaList){
