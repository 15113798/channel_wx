...
public class AdminCouponController {
    ...
    public Object list(String name, Short type, Short status,
        ...
        List<JinxiangCoupon> couponList = couponService.querySelective(name, type, status, page, limit, sort, order);
    ...
    public Object listuser(Integer userId, Integer couponId, Short status,
                       ...
                       @Sort @RequestParam(defaultValue = "add_time") String sort,
                       @Order @RequestParam(defaultValue = "desc") String order) {
        List<JinxiangCouponUser> couponList = couponUserService.queryList(userId, couponId, status, page, limit, sort, order);
        return ResponseUtil.okList(couponList);
    }

    private Object validate(JinxiangCoupon coupon) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody JinxiangCoupon coupon) {
    ...
    public Object read(@NotNull Integer id) {
        JinxiangCoupon coupon = couponService.findById(id);
        return ResponseUtil.ok(coupon);
    }
    ...
    @PostMapping("/update")
    public Object update(@RequestBody JinxiangCoupon coupon) {
        Object error = validate(coupon);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody JinxiangCoupon coupon) {
