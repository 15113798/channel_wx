...
public class AdminAdminController {
    ...
    public Object list(String username,
        ...
        List<JinxiangAdmin> adminList = adminService.querySelective(username, page, limit, sort, order);
        return ResponseUtil.okList(adminList);
    }

    private Object validate(JinxiangAdmin admin) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody JinxiangAdmin admin) {
    ...
    public Object read(@NotNull Integer id) {
        JinxiangAdmin admin = adminService.findById(id);
        return ResponseUtil.ok(admin);
    }
    ...
    @PostMapping("/update")
    public Object update(@RequestBody JinxiangAdmin admin) {
        Object error = validate(admin);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody JinxiangAdmin admin) {
        Integer anotherAdminId = admin.getId();
        if (anotherAdminId == null) {
            return ResponseUtil.badArgument();
        }
        ...
        JinxiangAdmin currentAdmin = (JinxiangAdmin) currentUser.getPrincipal();
