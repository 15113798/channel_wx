...
import com.baijuvip.jinxiang.db.service.JinxiangKeywordService;
...
public class AdminKeywordController {
    ...
    @Autowired
    private JinxiangKeywordService keywordService;
    ...
    public Object list(String keyword, String url,
        ...
        List<JinxiangKeyword> keywordList = keywordService.querySelective(keyword, url, page, limit, sort, order);
        return ResponseUtil.okList(keywordList);
    }

    private Object validate(JinxiangKeyword keywords) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody JinxiangKeyword keyword) {
    ...
    public Object read(@NotNull Integer id) {
        JinxiangKeyword keyword = keywordService.findById(id);
        return ResponseUtil.ok(keyword);
    }
    ...
    @PostMapping("/update")
    public Object update(@RequestBody JinxiangKeyword keyword) {
        Object error = validate(keyword);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody JinxiangKeyword keyword) {
