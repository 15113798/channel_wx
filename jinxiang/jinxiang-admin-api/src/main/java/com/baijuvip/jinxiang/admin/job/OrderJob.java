...
import com.baijuvip.jinxiang.db.service.JinxiangGoodsProductService;
import com.baijuvip.jinxiang.db.service.JinxiangOrderGoodsService;
...
public class OrderJob {
    ...
    public void checkOrderUnpaid() {
        ...
        List<JinxiangOrder> orderList = orderService.queryUnpaid(SystemConfig.getOrderUnpaid());
        for (JinxiangOrder order : orderList) {
            // 设置订单已取消状态
    ...
    public void checkOrderUnconfirm() {
        ...
        List<JinxiangOrder> orderList = orderService.queryUnconfirm(SystemConfig.getOrderUnconfirm());
        for (JinxiangOrder order : orderList) {
    ...
    public void checkOrderComment() {
        ...
        List<JinxiangOrder> orderList = orderService.queryComment(SystemConfig.getOrderComment());
        for (JinxiangOrder order : orderList) {
