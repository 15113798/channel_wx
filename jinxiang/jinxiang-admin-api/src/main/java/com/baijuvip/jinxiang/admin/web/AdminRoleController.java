...
import com.baijuvip.jinxiang.admin.util.AdminResponseCode;
import com.baijuvip.jinxiang.admin.vo.PermVo;
import com.baijuvip.jinxiang.admin.util.Permission;
import com.baijuvip.jinxiang.admin.util.PermissionUtil;
...
import static com.baijuvip.jinxiang.admin.util.AdminResponseCode.ROLE_NAME_EXIST;
import static com.baijuvip.jinxiang.admin.util.AdminResponseCode.ROLE_USER_EXIST;
...
public class AdminRoleController {
    ...
    public Object list(String name,
        ...
        List<JinxiangRole> roleList = roleService.querySelective(name, page, limit, sort, order);
        return ResponseUtil.okList(roleList);
    }

    @GetMapping("/options")
    public Object options(){
        List<JinxiangRole> roleList = roleService.queryAll();
    ...
    public Object read(@NotNull Integer id) {
        JinxiangRole role = roleService.findById(id);
        return ResponseUtil.ok(role);
    }


    private Object validate(JinxiangRole role) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody JinxiangRole role) {
    ...
    @PostMapping("/update")
    public Object update(@RequestBody JinxiangRole role) {
        Object error = validate(role);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody JinxiangRole role) {
        ...
        List<JinxiangAdmin> adminList = adminService.all();
        for(JinxiangAdmin admin : adminList){
    ...
    private List<PermVo> getSystemPermissions(){
        final String basicPackage = "com.baijuvip.jinxiang.admin";
    ...
    public Object updatePermissions(@RequestBody String body) {
        ...
        for(String permission : permissions){
            JinxiangPermission jinxiangPermission = new JinxiangPermission();
            jinxiangPermission.setRoleId(roleId);
            jinxiangPermission.setPermission(permission);
            permissionService.add(jinxiangPermission);
        }
        return ResponseUtil.ok();
    }
