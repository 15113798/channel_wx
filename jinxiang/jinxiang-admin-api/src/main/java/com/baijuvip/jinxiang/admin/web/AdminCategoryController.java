...
import com.baijuvip.jinxiang.admin.vo.CategoryVo;
import com.baijuvip.jinxiang.core.util.ResponseUtil;
import com.baijuvip.jinxiang.db.domain.JinxiangCategory;
import com.baijuvip.jinxiang.db.service.JinxiangCategoryService;
...
public class AdminCategoryController {
    ...
    public Object list() {
        ...
        List<JinxiangCategory> categoryList = categoryService.queryByPid(0);
        for(JinxiangCategory category : categoryList){
            ...
            List<JinxiangCategory> subCategoryList = categoryService.queryByPid(category.getId());
            for(JinxiangCategory subCategory : subCategoryList){
    ...
    private Object validate(JinxiangCategory category) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody JinxiangCategory category) {
    ...
    public Object read(@NotNull Integer id) {
        JinxiangCategory category = categoryService.findById(id);
        return ResponseUtil.ok(category);
    }
    ...
    @PostMapping("/update")
    public Object update(@RequestBody JinxiangCategory category) {
        Object error = validate(category);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody JinxiangCategory category) {
    ...
    public Object catL1() {
        ...
        for (JinxiangCategory category : l1CatList) {
