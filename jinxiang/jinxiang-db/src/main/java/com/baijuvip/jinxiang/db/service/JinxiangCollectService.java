...
import com.baijuvip.jinxiang.db.dao.JinxiangCollectMapper;
...
@Service
public class JinxiangCollectService {
    @Resource
    private JinxiangCollectMapper collectMapper;

    public int count(int uid, Integer gid) {
        JinxiangCollectExample example = new JinxiangCollectExample();
        example.or().andUserIdEqualTo(uid).andValueIdEqualTo(gid).andDeletedEqualTo(false);
        return (int) collectMapper.countByExample(example);
    }

    public List<JinxiangCollect> queryByType(Integer userId, Byte type, Integer page, Integer limit, String sort, String order) {
        JinxiangCollectExample example = new JinxiangCollectExample();
        JinxiangCollectExample.Criteria criteria = example.createCriteria();
    ...
    public JinxiangCollect queryByTypeAndValue(Integer userId, Byte type, Integer valueId) {
        JinxiangCollectExample example = new JinxiangCollectExample();
    ...
    public int add(JinxiangCollect collect) {
        collect.setAddTime(LocalDateTime.now());
        collect.setUpdateTime(LocalDateTime.now());
        return collectMapper.insertSelective(collect);
    }

    public List<JinxiangCollect> querySelective(String userId, String valueId, Integer page, Integer size, String sort, String order) {
        JinxiangCollectExample example = new JinxiangCollectExample();
        JinxiangCollectExample.Criteria criteria = example.createCriteria();
