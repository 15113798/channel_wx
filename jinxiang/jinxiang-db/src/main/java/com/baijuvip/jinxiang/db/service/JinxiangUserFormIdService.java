...
import com.baijuvip.jinxiang.db.dao.JinxiangUserFormidMapper;
...
@Service
public class JinxiangUserFormIdService {
    @Resource
    private JinxiangUserFormidMapper formidMapper;
     ...
     * @return
     */
    public JinxiangUserFormid queryByOpenId(String openId) {
        JinxiangUserFormidExample example = new JinxiangUserFormidExample();
     ...
     * @param userFormid
     */
    public int updateUserFormId(JinxiangUserFormid userFormid) {
        //更新或者删除缓存
     ...
     * @param userFormid
     */
    public void addUserFormid(JinxiangUserFormid userFormid) {
